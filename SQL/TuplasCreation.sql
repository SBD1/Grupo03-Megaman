...
(1, 'Chave da Nave', 'Chave feita para destrancar a porta da nave', '100', '80');

INSERT INTO consumivel (id, nome, descricao, valor_compra, valor_venda, modificador_dano, modificador_energia) VALUES 
(2, 'Arma-EXP-100', 'Material usado para melhorar as armas', '150', '100', '100', '0'),
(3, 'Arma-EXP-250', 'Material usado para melhorar as armas', '250', '200', '250', '0'),
(4, 'Arma-EXP-500', 'Material usado para melhorar as armas', '400', '300', '500', '0'),
(5, 'Arma-EXP-1000', 'Material usado para melhorar as armas', '600', '500', '1000', '0');

INSERT INTO equip (id, tipo) VALUES 
(6,'arma'),
(7,'armadura');

INSERT INTO armadura (id, nome, descricao, valor_compra, valor_venda, valor_upgrade, nivel, energia, ataque, defesa) VALUES 
(7, 'Armadura contra explosões', 'Armadura feita para ser resistente contra explosões de inimigos', '300', '260', '200', '1', '50', '0', '100');

INSERT INTO arma (id, nome, descricao, valor_compra, valor_venda, valor_upgrade, nivel, energia, ataque, agilidade) VALUES 
(6, 'Canhão Fumegante', 'Canhão feito de energia e metal. Arma lenta mas muito potente. Ideal para inimigos agrupados', '300', '260', '200', '1', '50', '400', '0');
...
INSERT INTO player (nome, hp, energia, ataque, defesa, evasao, agilidade, creditos, arma, armadura) VALUES 
('Mega Man', '999', '999', '20', '300', '300', '100', '1000', 6, 7);
